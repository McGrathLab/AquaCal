...
| 16 | `e1_band` | E1's **noise-axis** band (BAND-01 / MF-22) | E1 | `python -u -m experiments.e1_refractive_comparison --seeds "${E1_BAND_SEEDS}" --out "${OUT_DIR}"` | `exp1_band.csv` (256 rows), `exp1_parameter_band.csv` (384 rows), `e1_seed_band_provenance.json` | `synthetic_validation.py` (a different repository) | 2.8 | conc. |
