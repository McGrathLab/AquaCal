...
def _generate_config_yaml(
    ...
    lines.extend(
        [
            ...
            "  # max_calibration_frames: 150  # Max frames for Stage 3 (null = no limit)",
            "  # refine_intrinsics: false  # Stage 3's second pass, with intrinsics unlocked: refine focal lengths and principal points",
            "  # refine_auxiliary_intrinsics: false  # Auxiliary camera registration: refine auxiliary camera intrinsics",
            ...
            "  # stop_frame: null       # Stop at frame index N (exclusive) in extrinsic videos (uniform; sync-preserving). Use to drop contaminated end-of-video frames.",
            "",
            "validation:",
