...
| 260813-clj | Four pre-run todos + the E1 band re-run: ENV_VERSION_MATCH gate and `aquacal_version_declared` (a stale editable install was about to stamp 2.0.1 output as 1.8.0), `exp1_parameter_band.csv` emission, `opencv-python==4.13.*` tight pin + reproduction prose, `results_linux32gb/` provenance. The 10-seed band reproduces the 1.8.0-era sweep BIT-IDENTICALLY (max\|rel\| = 0.000e+00 over 240 rows) | 2026-08-13 | 25e65c0, 5ae6683, fa9ec3a, 3eb1f4a, 15fd4aa | [260813-clj-land-four-pre-run-todo-fixes-provenance-](./quick/260813-clj-land-four-pre-run-todo-fixes-provenance-/) |
