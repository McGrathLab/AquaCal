...
also find per-iteration trace CSVs and a conditioning `.npz` under `output/internals/`. See
[Benchmarking & Diagnostics](../guide/benchmarking.md) for the field-by-field schema of all
three.
